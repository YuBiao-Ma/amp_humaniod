...
from humanoidGym.algo.ppo.modules import Memory, RnnActor, RnnBaselineActor, RnnTerrianHeightActor_V1,RnnTerrianHeight_V2Actor,RnnTerrianHeight_V3Actor,RnnTerrianHeight_V4Actor,RnnTerrianHeightActor,RnnTerrianImageActor,RnnEstVelActor, RnnEstVelHeightActor, RnnEstVelHeightContactSiamActor, RnnEstVelHeightContactSiamNormActor, RnnEstVelHeightMorePrivSiamNormActor, RnnEstVelHeightPrivSiamActor, RnnEstVelHeightPrivSiamNormActor, RnnEstVelHeightSiamActor, RnnEstVelHeightSiamNormActor, RnnNextLatentActor, RnnNextSiamNormActor, RnnSimpleEstVelActor, RnnTerrianLatentActor, mlp_factory
...
class ActorCriticRecurrent(nn.Module):
    ...
    def __init__(self,   
        ...
        self.actor = RnnTerrianLatentActor(num_prop=num_prop,
                                      actor_dims=[512,256,128],
                                      num_actions=num_actions,
                                      activation=activation,
                                      rnn_num_hidden=256,
