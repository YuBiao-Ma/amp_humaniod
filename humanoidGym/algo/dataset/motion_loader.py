...
from humanoidGym.algo.dataset import motion_util, pose3d
from humanoidGym.algo.ppo.utils import quaternion_slerp
...
class AMPLoader:
    ...
    def __init__(
        ...
        for i, motion_file in enumerate(motion_files):
            ...
            with open(motion_file, "r") as f:
                ...
                print(f"[{motion_file}] AAAAAAAAAA motion_data.shape = {motion_data.shape}")
    ...
    def reorder_from_pybullet_to_isaac(self, motion_data):
        ...
        """
        print(f"Loaded motion_data shape: {motion_data.shape}")  # (帧数, 实际维度)
