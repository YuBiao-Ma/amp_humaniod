...
# MOTION_FILES = glob.glob('humanoidGym/datasets/mocap_stair_motions/*')
...
class G1UnevenStairAmpCfg( LeggedRobotCfg ):
    ...
    class terrain(LeggedRobotCfg.terrain):
        ...
        # terrain types: [flat,up slope,down slope,discrite, stairup, stairdown]
        terrain_proportions = [0.2, 0.15, 0.15, 0.2, 0.15, 0.15]
        # trimesh only:
...
class G1UnevenStairAmpCfgPPO( LeggedRobotCfgPPO ):
